...
// Split code into chunks: Dynamically import heavy MediaLightbox modal
...
export default function MediaPage() {
  ...
  useEffect(() => {
    fetchWithCache('media_list', () => clientSql`SELECT id, publisher_name, headline, article_url, publish_date, clipping_image, category FROM media_articles ORDER BY id ASC;`)
      .then((res: any) => {
