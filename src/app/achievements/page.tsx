...
export default function AchievementsPage() {
  ...
  const [isLoading, setIsLoading] = useState<boolean>(!achievements || achievements.length === 0);

  useEffect(() => {
    fetchWithCache('achievements_list', () => clientSql`SELECT id, year, title, competition, rank, location, image_url, description, is_featured FROM achievements ORDER BY year DESC, id ASC;`)
      .then((res: any) => {
