...
let mars = createPlanet({
  surface: {
    ...
    textures: {
      map: 'Asset/map.jpg',
      bumpMap: 'Asset/bump_map.png',
      specularMap: 'Asset/rgb_sketchmap.jpg'
    }
  },
  atmosphere: {
    size: 0.004,
    ...
    textures: {
      map: 'Asset/cloud_map.png',
      alphaMap: 'Asset/cloud_map.png'
    },
    glow: {
      size: 0.02,
      intensity: 0.7,
...
textureLoader.crossOrigin = true;
textureLoader.load('Asset/background.jpg', function (texture) {
